...
e19=$( awk '{print $2}' ./$datoms/19/fande.out )
e20=$( awk '{print $2}' ./$datoms/20/fande.out )
e21=$( awk '{print $2}' ./$datoms/21/fande.out )
e22=$( awk '{print $2}' ./$datoms/22/fande.out )
e23=$( awk '{print $2}' ./$datoms/23/fande.out )
e24=$( awk '{print $2}' ./$datoms/24/fande.out )
e25=$( awk '{print $2}' ./$datoms/25/fande.out )
e26=$( awk '{print $2}' ./$datoms/26/fande.out )
e27=$( awk '{print $2}' ./$datoms/27/fande.out )
e28=$( awk '{print $2}' ./$datoms/28/fande.out )
e29=$( awk '{print $2}' ./$datoms/29/fande.out )
e30=$( awk '{print $2}' ./$datoms/30/fande.out )
e31=$( awk '{print $2}' ./$datoms/31/fande.out )
e32=$( awk '{print $2}' ./$datoms/32/fande.out )
e33=$( awk '{print $2}' ./$datoms/33/fande.out )
e34=$( awk '{print $2}' ./$datoms/34/fande.out )
e35=$( awk '{print $2}' ./$datoms/35/fande.out )
e36=$( awk '{print $2}' ./$datoms/36/fande.out )


c2=$( awk '{print $2}' ./$dcats/2/fande.out )
c3=$( awk '{print $2}' ./$dcats/3/fande.out )
c4=$( awk '{print $2}' ./$dcats/4/fande.out )
c5=$( awk '{print $2}' ./$dcats/5/fande.out )
c6=$( awk '{print $2}' ./$dcats/6/fande.out )
c7=$( awk '{print $2}' ./$dcats/7/fande.out )
c8=$( awk '{print $2}' ./$dcats/8/fande.out )
c9=$( awk '{print $2}' ./$dcats/9/fande.out )
c10=$( awk '{print $2}' ./$dcats/10/fande.out )
c11=$( awk '{print $2}' ./$dcats/11/fande.out )
c12=$( awk '{print $2}' ./$dcats/12/fande.out )
c13=$( awk '{print $2}' ./$dcats/13/fande.out )
c14=$( awk '{print $2}' ./$dcats/14/fande.out )
c15=$( awk '{print $2}' ./$dcats/15/fande.out )
c16=$( awk '{print $2}' ./$dcats/16/fande.out )
c17=$( awk '{print $2}' ./$dcats/17/fande.out )
c18=$( awk '{print $2}' ./$dcats/18/fande.out )
c19=$( awk '{print $2}' ./$dcats/19/fande.out )
c20=$( awk '{print $2}' ./$dcats/20/fande.out )
c21=$( awk '{print $2}' ./$dcats/21/fande.out )
c22=$( awk '{print $2}' ./$dcats/22/fande.out )
c23=$( awk '{print $2}' ./$dcats/23/fande.out )
c24=$( awk '{print $2}' ./$dcats/24/fande.out )
c25=$( awk '{print $2}' ./$dcats/25/fande.out )
c26=$( awk '{print $2}' ./$dcats/26/fande.out )
c27=$( awk '{print $2}' ./$dcats/27/fande.out )
c28=$( awk '{print $2}' ./$dcats/28/fande.out )
c29=$( awk '{print $2}' ./$dcats/29/fande.out )
c30=$( awk '{print $2}' ./$dcats/30/fande.out )
c31=$( awk '{print $2}' ./$dcats/31/fande.out )
c32=$( awk '{print $2}' ./$dcats/32/fande.out )
c33=$( awk '{print $2}' ./$dcats/33/fande.out )
c34=$( awk '{print $2}' ./$dcats/34/fande.out )
c35=$( awk '{print $2}' ./$dcats/35/fande.out )
c36=$( awk '{print $2}' ./$dcats/36/fande.out )


a1=$( awk '{print $2}' ./$danis/1/fande.out )
a3=$( awk '{print $2}' ./$danis/3/fande.out )
a5=$( awk '{print $2}' ./$danis/5/fande.out )
a6=$( awk '{print $2}' ./$danis/6/fande.out )
a8=$( awk '{print $2}' ./$danis/8/fande.out )
a9=$( awk '{print $2}' ./$danis/9/fande.out )
a11=$( awk '{print $2}' ./$danis/11/fande.out )
a13=$( awk '{print $2}' ./$danis/13/fande.out )
a14=$( awk '{print $2}' ./$danis/14/fande.out )
a15=$( awk '{print $2}' ./$danis/15/fande.out )
a16=$( awk '{print $2}' ./$danis/16/fande.out )
a17=$( awk '{print $2}' ./$danis/17/fande.out )
a19=$( awk '{print $2}' ./$danis/19/fande.out )
a22=$( awk '{print $2}' ./$danis/22/fande.out )
a29=$( awk '{print $2}' ./$danis/29/fande.out )
a31=$( awk '{print $2}' ./$danis/31/fande.out )
a32=$( awk '{print $2}' ./$danis/32/fande.out )
a33=$( awk '{print $2}' ./$danis/33/fande.out )
a34=$( awk '{print $2}' ./$danis/34/fande.out )
a35=$( awk '{print $2}' ./$danis/35/fande.out )
...
echo "MSE12" $MSE12
echo "MAE" $MAE  
echo "MSE" $MSEversion)-($aref29)" | bc -l)
#err30=$( echo "(($e30)-($a30))*($unitconversion)-($aref30)" | bc -l)
err31=$( echo "(($e31)-($a31))*($unitconversion)-($aref31)" | bc -l)
err32=$( echo "(($e32)-($a32))*($unitconversion)-($aref32)" | bc -l)
err33=$( echo "(($e33)-($a33))*($unitconversion)-($aref33)" | bc -l)
