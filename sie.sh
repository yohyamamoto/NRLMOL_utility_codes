...
#molecule energy
e1=$( awk '{print $2}' ./$dmols/1/fande.out )
e2=$( awk '{print $2}' ./$dmols/2/fande.out )
e3=$( awk '{print $2}' ./$dmols/3/fande.out )
e4=$( awk '{print $2}' ./$dmols/4/fande.out )
e5=$( awk '{print $2}' ./$dmols/5/fande.out )
e6=$( awk '{print $2}' ./$dmols/6/fande.out )
e7=$( awk '{print $2}' ./$dmols/7/fande.out )
e8=$( awk '{print $2}' ./$dmols/8/fande.out )
e9=$( awk '{print $2}' ./$dmols/9/fande.out )
e10=$( awk '{print $2}' ./$dmols/10/fande.out )
e11=$( awk '{print $2}' ./$dmols/11/fande.out )
e12=$( awk '{print $2}' ./$dmols/12/fande.out )
e13=$( awk '{print $2}' ./$dmols/13/fande.out )
e14=$( awk '{print $2}' ./$dmols/14/fande.out )
e15=$( awk '{print $2}' ./$dmols/15/fande.out )
e16=$( awk '{print $2}' ./$dmols/16/fande.out )
e17=$( awk '{print $2}' ./$dmols/17/fande.out )
e18=$( awk '{print $2}' ./$dmols/18/fande.out )
e19=$( awk '{print $2}' ./$dmols/19/fande.out )
e20=$( awk '{print $2}' ./$dmols/20/fande.out )
e21=$( awk '{print $2}' ./$dmols/21/fande.out )
e22=$( awk '{print $2}' ./$dmols/22/fande.out )
e23=$( awk '{print $2}' ./$dmols/23/fande.out )
e24=$( awk '{print $2}' ./$dmols/24/fande.out )
e25=$( awk '{print $2}' ./$dmols/25/fande.out )
e26=$( awk '{print $2}' ./$dmols/26/fande.out )
e27=$( awk '{print $2}' ./$dmols/27/fande.out )
e28=$( awk '{print $2}' ./$dmols/28/fande.out )
e29=$( awk '{print $2}' ./$dmols/29/fande.out )
e30=$( awk '{print $2}' ./$dmols/30/fande.out )
e31=$( awk '{print $2}' ./$dmols/31/fande.out )
e32=$( awk '{print $2}' ./$dmols/32/fande.out )
e33=$( awk '{print $2}' ./$dmols/33/fande.out )
e34=$( awk '{print $2}' ./$dmols/34/fande.out )
e35=$( awk '{print $2}' ./$dmols/35/fande.out )
e36=$( awk '{print $2}' ./$dmols/36/fande.out )
eH2O=$( awk '{print $2}' ./$dmols/H2O/fande.out )
eH2Op=$( awk '{print $2}' ./$dmols/H2Op/fande.out )
eHe=$( awk '{print $2}' ./$dmols/He/fande.out )
eHep=$( awk '{print $2}' ./$dmols/Hep/fande.out )
eNH3=$( awk '{print $2}' ./$dmols/NH3/fande.out )
eNH3p=$( awk '{print $2}' ./$dmols/NH3p/fande.out )
